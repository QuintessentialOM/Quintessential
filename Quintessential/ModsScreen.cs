...
namespace Quintessential {
	...
	class ModsScreen : IScreen {
		...
		public void method_50(float param_4686) {
			Vector2 size = new Vector2(570f, 440f);
			...
			// label
			class_140.method_317(class_134.method_253("Mods", string.Empty), pos + new Vector2(95f, 341f), 356, true, true);
			// close button
			if(class_140.method_323(pos, size, new Vector2(466f, 342f))) {
